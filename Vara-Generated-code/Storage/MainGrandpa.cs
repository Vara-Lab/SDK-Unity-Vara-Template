...
namespace Substrate.Vara.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class GrandpaStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Grandpa", "State"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Grandpa", "PendingChange"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange)));
        ...
        ///  State of the current authority set.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState> State(string blockhash, CancellationToken token)
        {
            string parameters = GrandpaStorage.StateParams();
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Pending change: (signaled at, scheduled change).
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange> PendingChange(string blockhash, CancellationToken token)
        {
            string parameters = GrandpaStorage.PendingChangeParams();
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class GrandpaCalls
    {
        ...
        /// </summary>
        public static Method ReportEquivocation(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_consensus_grandpa.EquivocationProof equivocation_proof, Substrate.Vara.NET.NetApiExt.Generated.Model.sp_session.MembershipProof key_owner_proof)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ReportEquivocationUnsigned(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_consensus_grandpa.EquivocationProof equivocation_proof, Substrate.Vara.NET.NetApiExt.Generated.Model.sp_session.MembershipProof key_owner_proof)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(equivocation_proof.Encode());
            byteArray.AddRange(key_owner_proof.Encode());
