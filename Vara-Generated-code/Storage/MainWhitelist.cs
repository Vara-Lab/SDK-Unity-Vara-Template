...
namespace Substrate.Vara.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class WhitelistStorage
    {
        ...
        public WhitelistStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Whitelist", "WhitelistedCall"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.Vara.NET.NetApiExt.Generated.Model.primitive_types.H256), typeof(Substrate.NetApi.Model.Types.Base.BaseTuple)));
        }
        
        /// <summary>
        /// >> WhitelistedCallParams
        /// </summary>
        public static string WhitelistedCallParams(Substrate.Vara.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
        {
        ...
        /// >> WhitelistedCall
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple> WhitelistedCall(Substrate.Vara.NET.NetApiExt.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class WhitelistCalls
    {
        ...
        /// </summary>
        public static Method WhitelistCall(Substrate.Vara.NET.NetApiExt.Generated.Model.primitive_types.H256 call_hash)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RemoveWhitelistedCall(Substrate.Vara.NET.NetApiExt.Generated.Model.primitive_types.H256 call_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(call_hash.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method DispatchWhitelistedCall(Substrate.Vara.NET.NetApiExt.Generated.Model.primitive_types.H256 call_hash, Substrate.NetApi.Model.Types.Primitive.U32 call_encoded_len, Substrate.Vara.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight call_weight_witness)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(call_hash.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method DispatchWhitelistedCallWithPreimage(Substrate.Vara.NET.NetApiExt.Generated.Model.vara_runtime.EnumRuntimeCall call)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
