...
namespace Substrate.Vara.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class StakingRewardsStorage
    {
        ...
        ///  Target inflation (at ideal stake)
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perquintill> TargetInflation(string blockhash, CancellationToken token)
        {
            string parameters = StakingRewardsStorage.TargetInflationParams();
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perquintill>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Ideal staking ratio
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perquintill> IdealStakingRatio(string blockhash, CancellationToken token)
        {
        ...
        ///  Subsequently, the non-stakeable share should be calculated based on the vesting balances.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perquintill> NonStakeableShare(string blockhash, CancellationToken token)
        {
        ...
        ///  During the 1st year the non-stakeable amount is accounted for as a fixed fraction of TTS.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Types.Base.BTreeSetT6> FilteredAccounts(string blockhash, CancellationToken token)
        {
            string parameters = StakingRewardsStorage.FilteredAccountsParams();
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Types.Base.BTreeSetT6>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class StakingRewardsCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ForceRefill(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress from, Substrate.NetApi.Model.Types.Primitive.U128 value)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Withdraw(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress to, Substrate.NetApi.Model.Types.Primitive.U128 value)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
    ...
    public sealed class StakingRewardsConstants
    {
        ...
        /// </summary>
        public Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perquintill MinInflation()
        {
            var result = new Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perquintill();
        ...
        ///  ROI cap.
        /// </summary>
        public Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perquintill MaxROI()
        {
            var result = new Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perquintill();
        ...
        /// </summary>
        public Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perquintill Falloff()
        {
            var result = new Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perquintill();
