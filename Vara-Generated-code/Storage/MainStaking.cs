...
namespace Substrate.Vara.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class StakingStorage
    {
        ...
        ///  invulnerables) and restricted to testnets.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>> Invulnerables(string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.InvulnerablesParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string BondedParams(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  TWOX-NOTE: SAFE since `AccountId` is a secure hash.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> Bonded(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.BondedParams(key);
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  If set to `0`, no limit exists.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill> MinCommission(string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.MinCommissionParams();
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string LedgerParams(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Map from all (unlocked) "controller" accounts to the info regarding the staking.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.StakingLedger> Ledger(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.LedgerParams(key);
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.StakingLedger>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  TWOX-NOTE: SAFE since `AccountId` is a secure hash.
        /// </summary>
        public static string PayeeParams(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  TWOX-NOTE: SAFE since `AccountId` is a secure hash.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.EnumRewardDestination> Payee(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.PayeeParams(key);
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.EnumRewardDestination>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  TWOX-NOTE: SAFE since `AccountId` is a secure hash.
        /// </summary>
        public static string ValidatorsParams(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  TWOX-NOTE: SAFE since `AccountId` is a secure hash.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.ValidatorPrefs> Validators(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.ValidatorsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.ValidatorPrefs>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  TWOX-NOTE: SAFE since `AccountId` is a secure hash.
        /// </summary>
        public static string NominatorsParams(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  TWOX-NOTE: SAFE since `AccountId` is a secure hash.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.Nominations> Nominators(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.NominatorsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.Nominations>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  equal to [`SessionInterface::validators`].
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.ActiveEraInfo> ActiveEra(string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.ActiveEraParams();
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.ActiveEraInfo>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string ErasStakersParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> key)
        {
        ...
        ///  If stakers hasn't been set or has been removed then empty exposure is returned.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.Exposure> ErasStakers(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> key, string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.ErasStakersParams(key);
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.Exposure>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  If stakers hasn't been set or has been removed then empty exposure is returned.
        /// </summary>
        public static string ErasStakersClippedParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> key)
        {
        ...
        ///  If stakers hasn't been set or has been removed then empty exposure is returned.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.Exposure> ErasStakersClipped(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> key, string blockhash, CancellationToken token)
        {
        ...
        ///  Is it removed after `HISTORY_DEPTH` eras.
        /// </summary>
        public static string ErasValidatorPrefsParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> key)
        {
        ...
        ///  Is it removed after `HISTORY_DEPTH` eras.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.ValidatorPrefs> ErasValidatorPrefs(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> key, string blockhash, CancellationToken token)
        {
        ...
        ///  If reward hasn't been set or has been removed then 0 reward is returned.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.EraRewardPoints> ErasRewardPoints(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.ErasRewardPointsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.EraRewardPoints>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Mode of era forcing.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.EnumForcing> ForceEra(string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.ForceEraParams();
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.EnumForcing>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  The rest of the slashed value is handled by the `Slash`.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill> SlashRewardFraction(string blockhash, CancellationToken token)
        {
        ...
        ///  All unapplied slashes that are queued for later.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.UnappliedSlash>> UnappliedSlashes(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.UnappliedSlashesParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.UnappliedSlash>>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string ValidatorSlashInEraParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> key)
        {
        ...
        ///  and slash value of the era.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill, Substrate.NetApi.Model.Types.Primitive.U128>> ValidatorSlashInEra(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> key, string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.ValidatorSlashInEraParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill, Substrate.NetApi.Model.Types.Primitive.U128>>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string NominatorSlashInEraParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> key)
        {
        ...
        ///  All slashing events on nominators, mapped by era to the highest slash value of the era.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U128> NominatorSlashInEra(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string SlashingSpansParams(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Slashing spans for stash accounts.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.slashing.SlashingSpans> SlashingSpans(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.SlashingSpansParams(key);
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.slashing.SlashingSpans>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string SpanSlashParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32> key)
        {
        ...
        ///  as well as how much reward has been paid out.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.slashing.SpanRecord> SpanSlash(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32> key, string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.SpanSlashParams(key);
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.slashing.SpanRecord>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  (`CountFor*`) in the system compared to the configured max (`Max*Count`).
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Percent> ChillThreshold(string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.ChillThresholdParams();
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Percent>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class StakingCalls
    {
        ...
        /// </summary>
        public static Method Bond(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> value, Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.EnumRewardDestination payee)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Validate(Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.ValidatorPrefs prefs)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Nominate(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress> targets)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetPayee(Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.EnumRewardDestination payee)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(payee.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ScaleValidatorCount(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Percent factor)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetInvulnerables(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> invulnerables)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ForceUnstake(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 stash, Substrate.NetApi.Model.Types.Primitive.U32 num_slashing_spans)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method PayoutStakers(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 validator_stash, Substrate.NetApi.Model.Types.Primitive.U32 era)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ReapStash(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 stash, Substrate.NetApi.Model.Types.Primitive.U32 num_slashing_spans)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(stash.Encode());
            byteArray.AddRange(num_slashing_spans.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Kick(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress> who)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetStakingConfigs(Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.pallet.pallet.EnumConfigOp min_nominator_bond, Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.pallet.pallet.EnumConfigOp min_validator_bond, Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.pallet.pallet.EnumConfigOp max_nominator_count, Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.pallet.pallet.EnumConfigOp max_validator_count, Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.pallet.pallet.EnumConfigOp chill_threshold, Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking.pallet.pallet.EnumConfigOp min_commission)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ChillOther(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 controller)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ForceApplyMinCommission(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 validator_stash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(validator_stash.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetMinCommission(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill @new)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(@new.Encode());
