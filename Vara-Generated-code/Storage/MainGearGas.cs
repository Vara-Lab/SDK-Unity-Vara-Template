    ...
    public sealed class GearGasStorage
    {
        ...
        public GearGasStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("GearGas", "GasNodes"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Substrate.Vara.NET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNodeId), typeof(Substrate.Vara.NET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNode)));
        ...
        /// >> GasNodesParams
        /// </summary>
        public static string GasNodesParams(Substrate.Vara.NET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNodeId key)
        {
        ...
        /// >> GasNodes
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNode> GasNodes(Substrate.Vara.NET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNodeId key, string blockhash, CancellationToken token)
        {
            string parameters = GearGasStorage.GasNodesParams(key);
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNode>(parameters, blockhash, token);
            return result;
        }
