...
namespace Substrate.Vara.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class GearBankStorage
    {
        ...
        public GearBankStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("GearBank", "Bank"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_gear_bank.pallet.BankAccount)));
        ...
        /// >> BankParams
        /// </summary>
        public static string BankParams(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        /// >> Bank
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_gear_bank.pallet.BankAccount> Bank(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = GearBankStorage.BankParams(key);
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_gear_bank.pallet.BankAccount>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class GearBankConstants
    {
        ...
        /// </summary>
        public Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 BankAddress()
        {
            var result = new Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
        ...
        ///  Gas price converter.
        /// </summary>
        public Substrate.Vara.NET.NetApiExt.Generated.Model.gear_common.EnumGasMultiplier GasMultiplier()
        {
            var result = new Substrate.Vara.NET.NetApiExt.Generated.Model.gear_common.EnumGasMultiplier();
