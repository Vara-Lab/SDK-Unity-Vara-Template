...
namespace Substrate.Vara.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class ElectionProviderMultiPhaseStorage
    {
        ...
        public ElectionProviderMultiPhaseStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ElectionProviderMultiPhase", "CurrentPhase"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_election_provider_multi_phase.EnumPhase)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ElectionProviderMultiPhase", "QueuedSolution"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_election_provider_multi_phase.ReadySolution)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ElectionProviderMultiPhase", "Snapshot"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_election_provider_multi_phase.RoundSnapshot)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ElectionProviderMultiPhase", "SnapshotMetadata"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_election_provider_multi_phase.SolutionOrSnapshotSize)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ElectionProviderMultiPhase", "SignedSubmissionIndices"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Vara.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ElectionProviderMultiPhase", "SignedSubmissionsMap"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_election_provider_multi_phase.signed.SignedSubmission)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ElectionProviderMultiPhase", "MinimumUntrustedScore"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_npos_elections.ElectionScore)));
        }
        ...
        ///  Current phase.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_election_provider_multi_phase.EnumPhase> CurrentPhase(string blockhash, CancellationToken token)
        {
            string parameters = ElectionProviderMultiPhaseStorage.CurrentPhaseParams();
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_election_provider_multi_phase.EnumPhase>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Always sorted by score.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_election_provider_multi_phase.ReadySolution> QueuedSolution(string blockhash, CancellationToken token)
        {
            string parameters = ElectionProviderMultiPhaseStorage.QueuedSolutionParams();
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_election_provider_multi_phase.ReadySolution>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  This is created at the beginning of the signed phase and cleared upon calling `elect`.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_election_provider_multi_phase.RoundSnapshot> Snapshot(string blockhash, CancellationToken token)
        {
            string parameters = ElectionProviderMultiPhaseStorage.SnapshotParams();
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_election_provider_multi_phase.RoundSnapshot>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Only exists when [`Snapshot`] is present.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_election_provider_multi_phase.SolutionOrSnapshotSize> SnapshotMetadata(string blockhash, CancellationToken token)
        {
            string parameters = ElectionProviderMultiPhaseStorage.SnapshotMetadataParams();
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_election_provider_multi_phase.SolutionOrSnapshotSize>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  them one at a time instead of reading and decoding all of them at once.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27> SignedSubmissionIndices(string blockhash, CancellationToken token)
        {
            string parameters = ElectionProviderMultiPhaseStorage.SignedSubmissionIndicesParams();
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  affect; we shouldn't need a cryptographically secure hasher.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_election_provider_multi_phase.signed.SignedSubmission> SignedSubmissionsMap(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = ElectionProviderMultiPhaseStorage.SignedSubmissionsMapParams(key);
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_election_provider_multi_phase.signed.SignedSubmission>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Can be set via `set_minimum_untrusted_score`.
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_npos_elections.ElectionScore> MinimumUntrustedScore(string blockhash, CancellationToken token)
        {
            string parameters = ElectionProviderMultiPhaseStorage.MinimumUntrustedScoreParams();
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_npos_elections.ElectionScore>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class ElectionProviderMultiPhaseCalls
    {
        ...
        /// </summary>
        public static Method SubmitUnsigned(Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_election_provider_multi_phase.RawSolution raw_solution, Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_election_provider_multi_phase.SolutionOrSnapshotSize witness)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetMinimumUntrustedScore(Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_npos_elections.ElectionScore> maybe_next_score)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetEmergencyElectionResult(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.Vara.NET.NetApiExt.Generated.Model.sp_npos_elections.Support>> supports)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Submit(Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_election_provider_multi_phase.RawSolution raw_solution)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(raw_solution.Encode());
    ...
    public sealed class ElectionProviderMultiPhaseConstants
    {
        ...
        /// </summary>
        public Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill BetterSignedThreshold()
        {
            var result = new Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill();
        ...
        /// </summary>
        public Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill BetterUnsignedThreshold()
        {
            var result = new Substrate.Vara.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill();
        ...
        ///  this value.
        /// </summary>
        public Substrate.Vara.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight SignedMaxWeight()
        {
            var result = new Substrate.Vara.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight();
        ...
        /// >> MinerMaxWeight
        /// </summary>
        public Substrate.Vara.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight MinerMaxWeight()
        {
            var result = new Substrate.Vara.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight();
            result.Create("0x071059531A3313EC51B81E85EB5138");
            return result;
