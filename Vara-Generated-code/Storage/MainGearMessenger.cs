...
namespace Substrate.Vara.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class GearMessengerStorage
    {
        ...
        /// >> DispatchesParams
        /// </summary>
        public static string DispatchesParams(Substrate.Vara.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId key)
        {
        ...
        /// >> Dispatches
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.gear_common.storage.complicated.dequeue.LinkedNode> Dispatches(Substrate.Vara.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId key, string blockhash, CancellationToken token)
        {
            string parameters = GearMessengerStorage.DispatchesParams(key);
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.gear_common.storage.complicated.dequeue.LinkedNode>(parameters, blockhash, token);
            return result;
        }
        ...
        /// >> Head
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId> Head(string blockhash, CancellationToken token)
        {
            string parameters = GearMessengerStorage.HeadParams();
            var result = await _client.GetStorageAsync<Substrate.Vara.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId>(parameters, blockhash, token);
            return result;
        }
        ...
        /// >> MailboxParams
        /// </summary>
        public static string MailboxParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.Vara.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId> key)
        {
        ...
        /// >> Mailbox
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Vara.NET.NetApiExt.Generated.Model.gear_core.message.user.UserStoredMessage, Substrate.Vara.NET.NetApiExt.Generated.Model.gear_common.storage.primitives.Interval>> Mailbox(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.Vara.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId> key, string blockhash, CancellationToken token)
        {
            string parameters = GearMessengerStorage.MailboxParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Vara.NET.NetApiExt.Generated.Model.gear_core.message.user.UserStoredMessage, Substrate.Vara.NET.NetApiExt.Generated.Model.gear_common.storage.primitives.Interval>>(parameters, blockhash, token);
            return result;
        }
        ...
        /// >> Tail
        /// </summary>
        public async Task<Substrate.Vara.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId> Tail(string blockhash, CancellationToken token)
        {
        ...
        /// >> WaitlistParams
        /// </summary>
        public static string WaitlistParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Vara.NET.NetApiExt.Generated.Model.gear_core.ids.ProgramId, Substrate.Vara.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId> key)
        {
        ...
        /// >> Waitlist
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Vara.NET.NetApiExt.Generated.Model.gear_core.message.stored.StoredDispatch, Substrate.Vara.NET.NetApiExt.Generated.Model.gear_common.storage.primitives.Interval>> Waitlist(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Vara.NET.NetApiExt.Generated.Model.gear_core.ids.ProgramId, Substrate.Vara.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId> key, string blockhash, CancellationToken token)
        {
            string parameters = GearMessengerStorage.WaitlistParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Vara.NET.NetApiExt.Generated.Model.gear_core.message.stored.StoredDispatch, Substrate.Vara.NET.NetApiExt.Generated.Model.gear_common.storage.primitives.Interval>>(parameters, blockhash, token);
            return result;
        }
        ...
        /// >> DispatchStashParams
        /// </summary>
        public static string DispatchStashParams(Substrate.Vara.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId key)
        {
        ...
        /// >> DispatchStash
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Vara.NET.NetApiExt.Generated.Model.gear_core.message.stored.StoredDispatch, Substrate.Vara.NET.NetApiExt.Generated.Model.gear_common.storage.primitives.Interval>> DispatchStash(Substrate.Vara.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId key, string blockhash, CancellationToken token)
        {
