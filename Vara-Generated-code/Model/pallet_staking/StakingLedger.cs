...
namespace Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_staking
{
    ...
    public sealed class StakingLedger : BaseType
    {
        ...
        /// >> stash
        /// </summary>
        public Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 Stash { get; set; }
        /// <summary>
        /// >> total
        /// </summary>
        ...
        /// >> unlocking
        /// </summary>
        public Substrate.Vara.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9 Unlocking { get; set; }
        /// <summary>
        /// >> claimed_rewards
        /// </summary>
        public Substrate.Vara.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT10 ClaimedRewards { get; set; }
        ...
        {
            var start = p;
            Stash = new Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
            ...
            Unlocking = new Substrate.Vara.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9();
            Unlocking.Decode(byteArray, ref p);
            ClaimedRewards = new Substrate.Vara.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT10();
