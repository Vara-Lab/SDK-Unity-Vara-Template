...
namespace Substrate.Vara.NET.NetApiExt.Generated.Model.gear_common
{
    ...
    /// <summary>
    /// >> 553 - Composite[gear_common.CodeMetadata]
    /// </summary>
    ...
    public sealed class CodeMetadata : BaseType
    {
        ...
        /// >> author
        /// </summary>
        public Substrate.Vara.NET.NetApiExt.Generated.Model.primitive_types.H256 Author { get; set; }
        /// <summary>
        /// >> block_number
        /// </summary>
        ...
        {
            var start = p;
            Author = new Substrate.Vara.NET.NetApiExt.Generated.Model.primitive_types.H256();
