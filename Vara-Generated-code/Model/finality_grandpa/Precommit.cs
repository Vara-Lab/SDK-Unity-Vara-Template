...
namespace Substrate.Vara.NET.NetApiExt.Generated.Model.finality_grandpa
{
    ...
    public sealed class Precommit : BaseType
    {
        ...
        /// >> target_hash
        /// </summary>
        public Substrate.Vara.NET.NetApiExt.Generated.Model.primitive_types.H256 TargetHash { get; set; }
        /// <summary>
        /// >> target_number
        /// </summary>
        ...
        {
            var start = p;
            TargetHash = new Substrate.Vara.NET.NetApiExt.Generated.Model.primitive_types.H256();
